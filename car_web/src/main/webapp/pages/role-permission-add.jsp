...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form
				action="${pageContext.request.contextPath}/role/updateOne"
				method="post">
				<!-- 正文区域 -->
					...
					<table id="dataList"
							...
							<tbody>
								<c:forEach items="${RoleList}" var="role" varStatus="i">
									<tr>
										<td><input name="id" type="checkbox" checked="checked" value="${role.id}"></td>
										<td>${role.roleName}</td>
										<td><input type="text" name="roles" value="${role.roles}"> </td>
										<td>${role.phoneNum}</td>
									</tr>
								</c:forEach>
							</tbody>
