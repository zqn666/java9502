...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				店面管理 <small>添加店面</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/indexshou.jsp"><i
						class="fa fa-dashboard"></i> 首页</a></li>
				<li><a href="${pageContext.request.contextPath}/shops/findAll">店面管理</a></li>
				<li class="active">店面编辑</li>
			</ol>
			</section>
			<!-- 内容头部 /-->

			<!-- 正文区域 -->
			<section class="content"> <!--店面信息-->
			<form action="${pageContext.request.contextPath}/shops/save" method="post">
				
				<div class="panel panel-default">
					<div class="panel-heading">店面信息</div>
					<div class="row data-type">
						...
						<div class="col-md-2 title">店面名</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="店面名"
								 name="shop_name">
						</div>
