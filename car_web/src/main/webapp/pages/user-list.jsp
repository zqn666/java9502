	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/user/paging">用户管理</a></li>
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="删除" onclick="delMony()">
							...
							<%--搜索框--%>
							<form action="${pageContext.request.contextPath}/user/LikeUser">
							<div class="box-tools pull-right">
								<div class="has-feedback">
									<input type="text" class="form-control input-sm"
										placeholder="搜索" name="name"><input type="submit" value="搜索"> <span
							...
							<!--工具栏/-->
							<form action="${pageContext.request.contextPath}/user/delMony" id="delForm">
							<!--数据列表-->
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_asc sorting_asc_disabled">联系方式</th>
								...
								<tbody>
									<c:forEach items="${pageInfo.list}" var="user" varStatus="i">
										<tr>
											...
											<td>${user.tel }</td>
											<td>${user.name }</td>
											<td>${user.paperType }</td>
											<td>${user.paperNum }</td>
											<td>${user.email }</td>
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/user/findUI?uid=${user.uid}" class="btn bg-olive btn-xs">详情</a>
												<button type="button" class="btn bg-olive btn-xs" title="删除"
														onclick='delOne(${user.uid})'>
													<%--<i class="fa fa-trash-o"></i> --%>
													删除
												</button>
												<a href="${pageContext.request.contextPath}/user/findUpdate?uid=${user.uid}" class="btn bg-olive btn-xs">更改</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
		...
		<script>
			...
			//删除单个用户
				function delOne(id) {
					if (confirm("您确定要删除吗？")){
						location.href="${pageContext.request.contextPath}/user/del?uid="+id;
					}
	            }
            ...
            //分页
            	...
            	function gotoPage(currPage) {
             	   ...
             	   location.href="${pageContext.request.contextPath}/user/paging?currPage="+currPage+"&pageSize="+pageSize;
            	}
		...
		<script>
			...
			$.get('http://localhost:8080/users/findAll',function (option) {
				 console.log(option[0].Users)
            })
		</script>
</body>
