...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				店面管理 <small>店面详情</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="all-admin-index.html"><i
						class="fa fa-dashboard"></i> 首页</a></li>
				<li><a href="/shops/findAll">店面管理</a></li>
				<li class="active">店面详情</li>
			</ol>
			</section>
			<!-- 内容头部 /-->
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="店面编号"
							value="${shops.orderNum }" readonly="readonly">
					</div>
					...
					<%--<div class="col-md-10" style="height: 200px" readonly="readonly">--%>
						<%--<img src="../img${shop.images}" alt="店面美照">--%>
					<%--</div>--%>
			...
			<div class="box-tools text-center">
				<button type="button" class="btn bg-default"
						onclick="history.back(-1);">修改</button>
				<button type="button" class="btn bg-default"
