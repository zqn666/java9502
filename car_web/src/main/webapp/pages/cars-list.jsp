...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
					...
					<div class="table-box">
						...
						<form id="delForm" action="${pageContext.request.contextPath}/cars/delMany">
							<table id="dataList"
								...
								<tbody>
									<c:forEach items="${all}" var="car" varStatus="i">
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2019-2020 <a href="">课工场第一组</a>.
			...
			$.get(
                ...
                function (data) {
                    ...
                    $.each(data,function(index,element){
                        s+="<div onmouseout='out(this)' onmouseover='over(this)' style='border-bottom:1px solid #606060;color:#802F75;padding: 5px'>"+element.cNum+"</div>";
                    });
                    kDiv.html(s);
                },
                "json"
