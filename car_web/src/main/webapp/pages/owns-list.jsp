...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				车主管理 <small>全部车主</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/indexshou.jsp"><i
						class="fa fa-dashboard"></i> 首页</a></li>
				<li><a
					href="${pageContext.request.contextPath}/pages/order-list.jsp">车主管理</a></li>
				<li class="active">全部车主</li>
			</ol>
			</section>
			<!-- 内容头部 /-->
						...
						<table id="dataList"
							...
							<thead>
								<tr>
									...
									<th class="sorting">车主名</th>
									<th class="sorting">车主电话</th>
									<th class="sorting">车主身份证号</th>
							...
							<tbody>
								<c:forEach items="${all}" var="own" varStatus="i">
									<tr>
										...
										<td class="text-center">
											...
											<button type="button" class="btn bg-olive btn-xs"
													onclick='location.href="all-order-manage-edit.html"'>销户</button>
										</td>
									</tr>
								</c:forEach>
