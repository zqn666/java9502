					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="订单编号"
								 name="order_Num" value="${map.get("list").get(0)}">
						</div>

						<div class="col-md-2 title">生成时间</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="生成时间"
								 name="b_time" value="${map.get("list").get(1)}">
						</div>

						<div class="col-md-2 title">选择用户</div>
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
									name="uid">
								<c:forEach items="${ map.get('userAll') }" var="user">
									<option value="${ user.uid }" >${ user.name }&nbsp;&nbsp;&nbsp;${user.tel}</option>
								</c:forEach>
							</select>
						</div>


						<div class="col-md-2 title">选择车型</div>
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
								name="cid">

								<c:forEach items="${map.get('carAll')}" var="car">
									<option value="${ car.cid }" >${car.h_price}&nbsp;&nbsp;&nbsp;${car.d_price}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											${car.city}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											${car.ctype}${ car.cname}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											${car.cNum}</option>
								</c:forEach>
						...
						<div class="col-md-10 data rowHeight2x">
							<textarea class="form-control" rows="3" placeholder="订单描述" name="order_Desc">
						</textarea>
						</div>
